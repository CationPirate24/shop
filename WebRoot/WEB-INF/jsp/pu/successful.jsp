...
<div class="am-container header">
  ...
  <ul class="message-r">
    <div class="topMessage home"><div class="menu-hd"><a href="toWelcome.do" target="_top" class="h">商城首页</a></div></div>
    <div class="topMessage my-shangcheng"><div class="menu-hd MyShangcheng"><a href="toWriteMember.do" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div></div>
    <div class="topMessage mini-cart"><div class="menu-hd"><a id="mc-menu-hd" href="#" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h"></strong></a></div></div>
...
<div class="nav white">
	<div class="logo"><img src="<%=basePath%>pic/_o/50/a7/735e2614e3911e621f0446e54597_204_52.c5.png" /></div>
    <div class="logoBig">
...
<div class="footer" >
 ...
 <a href="#">联系我们</a>
 <a href="#">网站地图</a>
 <em>© 2015-2025 Yatuo.com 版权所有</em>
 </p>
 </div>
</div>
