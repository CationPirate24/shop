												...
												<li class="td td-item">
													...
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${u.name}</a>
														</div>
													</div>
												</li>
												<li class="td td-info">
													<div class="item-props">
														<span class="sku-line">${u.textture}</span>
														<span class="sku-line">${u.type}</span>
													</div>
												</li>
												<li class="td td-price">
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<em class="J_Price price-now">${u.price}</em>
														</div>
													</div>
												</li>
											</div>
												...
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															...
															--%><input  name="num" type="text" value="${u.num1}" style="width:30px;" />
						...
						<!--留言-->
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计（含运费） <span>¥</span><em class="pay-sum">${totalmoney}</em>
								</p>
							</div>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">${totalmoney}</em>
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											...
											<form id="tijiao" action="toBuyingGood1.do" method="post">
												<input type="hidden" name="totalPrice" value="${totalmoney}"/>
                                    			<input type="hidden" name="addressId"  id="tijiao1"/>
                                    			<input type="hidden" name="goodsId" value="${u.goodsId}"/>
				...
				<div class="footer">
					...
					<div class="footer-bd">
						<p>
							...
							<a href="#">联系我们</a>
							<a href="#">网站地图</a>
							<em>© 2015-2025 jinyu.com 版权所有</em>
						</p>
					</div>
				</div>
			</div>
