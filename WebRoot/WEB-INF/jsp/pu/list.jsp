...
var Meilishuo = {
	...
	<body>
		<div class="head">
              ...
              <div class="inner">
                <ul>
                  ...
                  <li class="drop">
                    ...
                    <ul class="down">
                      <li>
                        <a href="java:script(0)" target="_blank">买家服务</a></li>
                      <li>
                        <a href="java:script(0)" target="_blank">商家服务</a></li>
                      <li>
                        <a href="java:script(0)" target="_blank">规则中心</a></li>
                    </ul>
                  </li>
                  <li>
			...
			<div id="com-search">
				<div class="inner">
					<a href="public/toWelcome.do" class="logo"> <img
							src="<%=basePath%>pic/_o/50/a7/735e2614e3911e621f0446e54597_204_52.c5.png"
							alt=""> </a>
					<a href="public/toWelcome.do" class="sublogo"> </a>
				...
				<li class="product-list fl">
					<div class="img-size">
						<a class="img-link" target="_blank"
							href="public/toGd.do?ID=${u.goodsId}"
		...
		<div id="com-foot">
			<div class="inner">
				<div class="flist">
					...
					<div>
						<a href="java:script(0)" target="_blank">新手指南</a>
					</div>
					<div>
						<a href="java:script(0)" target="_blank">服务保障</a>
					</div>
					<div>
						<a href="java:script(0)" target="_blank">常见问题</a>
					</div>
					<div>
						<a href="java:script(0)" target="_blank">购物帮助</a>
					</div>
				</div>
				<div class="flist">
					<h4>
					...
					<div>
						<a href="java:script(0)" target="_blank">商家入驻</a>
					</div>
					<div>
						<a href="java:script(0)" target="_blank">商家后台</a>
					</div>
					<div>
						<a href="java:script(0)" target="_blank">商家推广</a>
					</div>
				</div>
				<div class="flist">
					<h4>
