...
<%
	...
	MyUser u=(MyUser)request.getSession().getAttribute("u");
	MyAccount ac=(MyAccount)request.getSession().getAttribute("ac");
	...
	<body onload="jz()">
		...
		<div class="center">
				...
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="info-m">
								<div><b>用户名：<i>${ac.username}</i></b></div>
								<div class="u-level">
									<span class="rank r2">
							...
							<form class="am-form am-form-horizontal" action="public/member.do" method="post">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" value="${u.name}"  name="name">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" value="${u.phone}" type="tel" name="phone"/>
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-email"  value="${u.email}"  name="email"  type="email">
			...
			<aside class="menu">
				<ul>
					<li class="person">
						<a href="public/toWriteMember.do">个人中心</a>
					</li>
					<li class="person">
