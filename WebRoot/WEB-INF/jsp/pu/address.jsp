...
<html>
	...
	<head>
		...
		function delClick(){
			...
			document.getElementById("addressDe").submit();
			
		}
		function save(){
			document.getElementById("saveId").submit();
						...
						<c:forEach items="${list}" var="u">
							<li class="user-addresslist defaultAddr">
								...
								<p class="new-tit new-p-re">
									...
									<span class="new-txt-rd2">${u.phone}</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">地址：</span>
										<span class="province">${u.address}</span>
										</p>
								</div>
								<div class="new-addr-btn">
									<!-- <a href="#"><i class="am-icon-edit"></i></a>
									<span class="new-addr-bar"></span> -->
									<form  id="addressDe" action="public/addressDe.do" method="post">
									<input  type="hidden" name="addressId" value="${u.id}" />
									</form>
									<i class="" ><input type="submit" value="删除" onclick="delClick()"/></i>
								</div>
							</li>
</c:forEach>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									...
									<form class="am-form am-form-horizontal" action="public/address.do" id="saveId" method="post">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" id="user-intro"  name="uaddress"  placeholder="输入详细地址"></textarea>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a ><input type="submit" value="保存" onclick="save()"/></a>
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="public/toaddress.do">收货地址</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的交易</a>
						<ul>
							<li><a href="public/toMangerOrder.do">订单管理</a></li>
