  ...
  <c:forEach items="${list}" var="m" varStatus="loop"> 
		...
		<tbody>
			<tr class="text-c">
				...
				<td><u style="cursor:pointer" class="text-primary" >${m.name}</u></td>
				<td>${m.type}</td>
				<td>${m.integral}</td>	
				...
				<i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','user/toMemberUpdate.do','4','','510')" class="ml-5" style="text-decoration:none">
