...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            name: '戒指',
            data: [179.9, 71.5, 56.4, 100.2, 144.0, 76.0, 90.6, 80.5, 186.4, 216.4, 95.6, 84.4]

        }, {
            name: '项链',
            data: [153.6, 78.8, 98.5, 93.4, 106.0, 84.5, 105.0, 91.2,104.3, 183.5, 86.6, 92.3]
            ...
            name: '手镯',
            data: [142.4, 53.2, 60.5, 40.7, 100.6, 75.5, 57.4, 60.4, 90.6, 139.1, 46.8, 51.1]
