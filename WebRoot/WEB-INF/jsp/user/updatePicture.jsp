...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="updatePic.do" method="post">
		
		<div class="row cl">
		
			<!--<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片ID：</label>-->
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="${pic.id}"  name="id1">
				<input type="hidden" class="input-text" value="${pic.goodsId}"  name="id2">
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" id="datemin" name="path" value="${pic.doPath}" class="input-text Wdate">
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'datemin\')}'})" id="datemax" name="goodsName" value="${pic.goodsName}" class="input-text Wdate">
			</div>
