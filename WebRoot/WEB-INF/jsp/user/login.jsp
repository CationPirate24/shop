    ...
    <form class="form form-horizontal" action="login.do" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="username1" name="username" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="password1" name="password" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright 版权所有 雅拓珠宝</div>
